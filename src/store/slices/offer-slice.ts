...
import {mapOfferCity, mapOffersCities} from '../../utils/offer-mapping.ts';
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(changeFavoriteStatusAction.fulfilled, (state, action) => {
        const updatedOffer = mapOfferCity(action.payload);
